...
const Footer = () => {
  return (
        <>
      <div className="w-full h-screen bg-zinc-900 flex gap-10 p-20 rounded-tr-3xl rounded-tl-3xl">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="headings">
          <h1 className="uppercase font-semibold text-[5vw] tracking-tight leading-none">
            eye-
          </h1>
          <h1 className="uppercase font-semibold text-[5vw] tracking-tight leading-none">
            opening
      ...
      <div className="w-1/2">
        <h1 className="uppercase font-semibold text-[8vw] tracking-tight leading-none -mb-10">
          presentations
        </h1>
      </div>
      <div className=' font-["Neue_Montreal"] mt-40 leading-9'>
      ...
      <div className="flex text-end items-center bg-zinc-900 ">
        <a className="opacity-30 text-xl w-[90vw]" href="/">Website by Prathamesh Pote</a>
      </div>
    </>
  );
};
